  ...
  return (
    <header className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 border-b border-border">
      ...
      >
        ...
        {/* Menu Panel */}
        <div
          className={`absolute top-0 right-0 w-full max-w-sm h-[calc(100vh-4rem)] md:h-[calc(100vh-4.5rem)] bg-background shadow-xl transition-transform duration-300 ease-out overflow-y-auto ${
